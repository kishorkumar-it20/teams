      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Punch In Out/ View Today's Attendance</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Today's Attendance</h6>
        </nav>
        ...
        <div>
          <div class="card">
            ...
            <div class="card-body px-0 pb-2">
              ...
              <table class="table align-items-center mb-0  space-y-4">
                <thead>
                    <tr>
                        ...
                        <th class="text-center text-uppercase text-secondary text-sm font-weight-bolder opacity-7">IP Address</th>
                        <th class="text-center text-uppercase text-secondary text-sm font-weight-bolder opacity-7">Loction</th>
                  ...
                  <?php  
                    $todayx = date("Y-m-d");
                        $query = "SELECT * FROM attendance WHERE datex='$todayx'";
                    ...
                    $result = $db->query($query);
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                              $mode = $row['modex'];
                                echo "<tr>";
                                echo "<td class='text-center text-sm font-italic'>" . $i. "</td>";
                                echo "<td class='text-center text-sm font-italic'>" . $row["datex"]. "</td>";
                                $uid_for_name = $row["uid"];
                        // SQL query to fetch the user
                    $sql2 = "SELECT name FROM members WHERE id='$uid_for_name'";
                    $result2 = $db->query($sql2);
                    $value_name = $result2->fetch_assoc();
                    echo "<td class='text-center text-md font-italic'>".$value_name['name']."</td>";
                                echo "<td class='text-center text-md font-italic'>" . $row["punchin"]. "</td>";
                                echo "<td class='text-center text-md font-italic'>" . $row["punchout"]. "</td>";
                                echo "<td class='text-center'>";
                                echo "<span class='mode-label mode-" . strtolower($mode) . "'>" . ucfirst($mode) . "</span>";
                                echo "</td>";
                                echo "<td class='text-center text-md font-italic'>" . $row["total_prod"]. "</td>";
                                echo "<td class='text-center text-md font-italic'>" . $row["ip_addre"]. "</td>";
                                echo "<td class='text-center text-md font-italic'><a href='https://www.google.com/search?q=".$row["lat_lang"]."'>" . $row["lat_lang"]. "</a></td>";
                            echo "</tr>";
                            $i++;
                            }
                        } else {
